function Rationale__() {
    return (
      ...
      <p>The purpose of this course is to properly equip and empower those Americans, who recognize the disastrous threat of the Left’s end game to destroy our nation and our way of life,

        an effort to identify the Alinsky strategies in their “strengths”, but more importantly the limits on what can be accomplished through them. The goal is not merely to provide an exposition of sordid leftist tactics, which would limit Conservatives to a strictly defensive posture, but rather to counter the entire collection of underhanded tactics being used by them. Furthermore, the goal is

        to properly equip and empower those Americans who recognize the disastrous threat of the Left’s end game to destroy our nation and our way of life. The focus is on identifying the pattern of Alinsky attacks, so that Conservatives can recognize their presence, gain an understanding of the nature, and by doing so, more quickly and effectively establish counter strategies using a ethical approach.</p><h1>Page Break 3</h1><h2>Saul Alinsky and his “Rules for Radicals”</h2></>
       );
